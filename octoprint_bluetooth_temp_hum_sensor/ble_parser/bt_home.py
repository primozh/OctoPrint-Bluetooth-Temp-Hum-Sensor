...
def parse_bthome(uuid16, source_mac, data, aeskeys):
    ...
    if uuid16 == 0x181C:
        ...
        try:
            payload, count_id = decrypt_data(data, ha_ble_mac, aeskeys)
        except TypeError:
            return None
...
def decrypt_data(data, ha_ble_mac, aeskeys):
